...
class StockReportRAG:
    ...
    def generate_response(self, query, context):
        ...
        prompt = f"""You are a specialized stock analysis assistant that helps analyze financial reports.
I'll provide you with context from various stock reports, and you need to answer the question based only on this information.
